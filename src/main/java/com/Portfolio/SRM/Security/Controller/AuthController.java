...
import com.Portfolio.SRM.Security.Entity.Usuario;
import com.Portfolio.SRM.Security.Enums.RolNombre;
import com.Portfolio.SRM.Security.Service.RolService;
import com.Portfolio.SRM.Security.Service.UsuarioService;
import com.Portfolio.SRM.Security.jwt.JwtProvider;
...
@RestController
@RequestMapping("/auth")
@CrossOrigin(origins = {"https://portfolio-web-di2q.onrender.com","http://localhost:4200"})
